...
<task type="checkpoint" gate="blocking">
  ...
  <files>static/index.html</files>
  <action>
Human verification of complete browser input capture surface. All automated work is complete - this checkpoint confirms the full Phase 2 implementation works correctly.
...
Type "approved" if all pass, or describe what failed.
  </verify>
  <done>
Human has verified all Phase 2 input capture requirements are working correctly. All mouse and keyboard events captured, default behaviors prevented, visual appearance correct.
  </done>
</task>
