...
Output: Verification checkpoint confirming coordinate accuracy.
</objective>
...
<task type="checkpoint:human-verify" gate="blocking">
  <name>Task 1: Verify coordinate mapping accuracy</name>
  <what-built>
...
**What to report:**
- Your display type (Retina/non-Retina) and resolution
- Corner mapping: PASS/FAIL for each corner
- Center mapping: PASS/FAIL
- Any observed issues with accuracy or cursor behavior
  </how-to-verify>
  <resume-signal>
